...
<font align="justify">
    ...
    Kota Tangerang Selatan serta, apabila terdapat kekeliruan/kesalahan dalam pembuatannya. Pemohon/pemegang bersedia
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($penghasilan->tanggal_penghasilan)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
