...
class Pemakaman extends CI_Controller
{
    ...
    public function edit($id)
    {
        ...
        $this->form_validation->set_rules('tanggal_dimakamkan', 'Tanggal Dimakamkan', 'required');
        $this->form_validation->set_rules('hari_pemakaman', 'Hari Pemakaman', 'required');
        $this->form_validation->set_rules('jam_dimakamkan', 'Jam Dimakamkan', 'required');
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data = array(
                ...
                'hari_pemakaman' => $this->input->post('hari_pemakaman'),
                'tanggal_dimakamkan' => $this->input->post('tanggal_dimakamkan'),
                'jam_dimakamkan' => $this->input->post('jam_dimakamkan'),
            );
