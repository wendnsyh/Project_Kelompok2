...
<br /><br />
<center>
    <font size="5"><u><b>SURAT KETERANGAN PINDAH WNI</b></u></font><br />Antar Desa/Kelurahan Dalam Satu Kecamatan <br />Nomor: ..............................
</center>
<br /><br /><br />
...
<table width="100%">
    ...
    <tr>
        ...
        <td>Kota</td>
        <td>:</td>
        <td><?php echo $pindah->kota_pindah; ?></td>
    </tr>
    <tr>
        <td></td>
        <td>Provinsi</td>
...
<table class="tabelku">
    <tr class="trku">
        <td class="tdku" width="3%"><b>
                <center>NO.</center>
            </b></td>
        <td class="tdku" width="27%"><b>
                <center>NIK</center>
            </b></td>
        <td class="tdku" width="40%"><b>
                <center>NAMA</center>
            </b></td>
    </tr>
    <?php
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?php echo $pindah->tanggal_pindah; ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>Dikeluarkan oleh: <br />a.n. Kepala Dinas Kependudukan dan Pencatatan Sipil<br />Kepala Kelurahan Serpong</center>
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>
            <center><b><u><?php echo $pindah->nama_pejabat; ?></u></b></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>NIP. <?php echo $pindah->nip_pejabat; ?></center>
        </td>
    </tr>
</table>
<script>
