...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , Kepala Kelurahan Serpong Kecamatan Serpong Kota Tangerang Selatan
    Provinsi Banten, Menerangkan bahwa
</font>
<table width="100%">
    <tr>
    ...
    <tr>
        <td>Agama</td>
        <td>:</td>
        <td><?php echo $pemakaman->agama; ?></td>
    </tr>
    <tr>
        <td>Alamat</td>
        <td>:</td>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($pemakaman->tanggal_pemakaman)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
