<!-- Begin Page Content -->
    <div class="container mb-4" style="display: flex; justify-content: center;">
        <img src="<?php echo base_url('assets/img/backgrounds/dashboard.jpg'); ?>" style="width: 100%; height: auto; border: 1px solid #62aad4; border-radius: 10px; box-shadow: 10px 10px 5px 0px rgba(189,185,185,0.75);">
    </div>
