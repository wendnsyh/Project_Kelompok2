    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body table-responsive">
                ...
                ?>
                <p>
                    <a href="<?php echo base_url('Pemakaman/tambah'); ?>" class="btn btn-success ml-2">Tambah Surat
                        Pemakaman</a>
                </p>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    ...
                                    <a href="<?php echo base_url('Pemakaman/hapus/' . $surat->id_pemakaman); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Yakin Akan Menghapus Data?');"><i class="fa fa-trash-o"></i> Hapus</a>
                                    <a target="blank" href="<?php echo base_url('Pemakaman/cetak/' . $surat->id_pemakaman); ?>" class="btn btn-info btn-xs mt-2"><i class="fa fa-print"></i> Cetak</a>
                            </tr>
                            </td>
                        <?php
                            $no++;
