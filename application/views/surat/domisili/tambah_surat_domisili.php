                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <form action="<?php echo base_url('SuratDomisili/tambah/'); ?>" method="post">

                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>NIK</label><a href="<?php echo base_url(); ?>penduduk/tambah/" class="btn btn-sm btn-primary pull-right">Tambah
                                                Penduduk</a><br /><br />
