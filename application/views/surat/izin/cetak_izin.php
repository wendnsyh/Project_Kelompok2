...
<br />
<font align="justify">
    Saya memberikan ijin kepada Anak saya yang tercantum di bawah ini, yang akan bekerja Keluar Negeri sebagai (TKI) di
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($izin_keluarga->tanggal_izin_keluarga)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
