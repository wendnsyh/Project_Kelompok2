...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $haji->jabatan_pejabat; ?> Kelurahan Serpong Kecamatan Serpong
...
<table width="100%">
    ...
    <tr>
        ...
        <td>:</td>
        <td><?php echo $haji->tanggal_berangkat; ?></td>
    </tr>
    <tr>
        <td>Alamat</td>
        <td>:</td>
...
<br />
<font align="justify">
    Nama tersebut diatas benar Warga Kelurahan Serpong Kecamatan Serpong Kota Tangerang Selatan Provinsi Banten .
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($haji->tanggal_haji)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
