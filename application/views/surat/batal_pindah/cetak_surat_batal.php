...
<br /><br /><br />
<center>
    <font size="5"><u><b>SURAT KETERANGAN</b></u></font><br />Nomor: 470/<?php echo $batal_pindah->id_batal_pindah; ?>/II/DS/<?php echo substr($batal_pindah->tanggal_batal_pindah, 0, 4); ?>
</center>
<br /><br />
<font align="justify">
...
<table width="100%">
    ...
    <tr>
        <td>Agama</td>
        <td>:</td>
        <td><?php echo $batal_pindah->agama; ?></td>
    </tr>
    <tr>
...
<br />
<font align="justify">
    Menurut penilitian kami dan surat pengantar dari RT-nya bahwa Nama/Orang tersebut benar Warga Kelurahan Serpong, dan bertempat tinggal dialamat tersebut diatas. Menerangkan bahwa yang bersangkutan diatas benar batal Pindah ke alamat di bawah ini;<br />
</font>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($batal_pindah->tanggal_batal_pindah)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td></td>
        <td>
            <center>Kecamatan Serpong</center>
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>
            <center><b><u><?php echo $batal_pindah->nama_pejabat; ?></u></b></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>NIP. <?php echo $batal_pindah->nip_pejabat; ?></center>
        </td>
    </tr>
</table>
<script>
