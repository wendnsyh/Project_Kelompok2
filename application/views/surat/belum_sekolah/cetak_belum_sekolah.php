...
<br /><br /><br />
<center>
    <font size="5"><u><b>SURAT KETERANGAN Kelurahan</b></u></font><br />Nomor:
    145/<?php echo $belum_sekolah->id_belum_sekolah; ?>/DS/<?php echo substr($belum_sekolah->tanggal_belum_sekolah, 0, 4); ?>
</center>
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , Kepala Kelurahan Serpong Kecamatan Serpong Kota Tangerang Selatan Provinsi Banten, dengan ini menerangkan bahwa :
</font>
<table width="100%">
    <tr>
    ...
    <tr>
        <td>Agama</td>
        <td>:</td>
        <td><?php echo $belum_sekolah->agama; ?></td>
    </tr>
    <tr>
        <td>Alamat</td>
        <td>:</td>
...
<br /><br />
<font align="justify">
    Nama / Orang tersebut benar Warga Kelurahan Serpong Kecamatan Serpong Kota Tangerang Selatan , Menerangkan dengan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($belum_sekolah->tanggal_belum_sekolah)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
