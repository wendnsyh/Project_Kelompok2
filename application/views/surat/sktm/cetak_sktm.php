...
<center>
    ...
    470/<?php echo $sktm->id_sktm; ?>/DS/<?php echo substr($sktm->tanggal_sktm, 0, 4); ?>
</center>
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $sktm->jabatan_pejabat; ?> Desa Serpong Kecamatan Serpong Kota Tangerang Selatan
    Provinsi Banten
</font>
<table width="100%">
    <tr>
        <td width="20%">Nama</td>
        <td width="3%">:</td>
        <td width="77%"><?php echo $sktm->nama; ?></td>
    </tr>
    <tr>
        <td>Jenis Kelamin</td>
        <td>:</td>
    ...
    <tr>
        ...
        <td>:</td>
        <td><?php echo $sktm->tempat_lahir; ?> /
            <?= date('d F Y', strtotime($sktm->tanggal_lahir)); ?>
        </td>
    </tr>
    <?php
    $ayah = $this->db->query("SELECT * FROM penduduk WHERE nik='$sktm->nik_ayah'")->row();
    ?>
    <tr>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Serpong, <?= date('d F Y', strtotime($sktm->tanggal_sktm)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>Kepala Desa Serpong</center>
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>
            <center><b><u><?php echo $sktm->nama_pejabat; ?></u></b></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>NIP. <?php echo $sktm->nip_pejabat; ?></center>
        </td>
    </tr>
</table>
<script>
