...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2024 at 04:19 PM
...
--
-- Table structure for table `belum_sekolah`
--
...
INSERT INTO `pejabat` (`id_pejabat`, `jenis_kelamin`, `alamat`, `nama_pejabat`, `nip_pejabat`, `jabatan_pejabat`) VALUES
...
INSERT INTO `pindah` (`id_pindah`, `id_pejabat`, `nik_kepala_keluarga`, `nik_pemohon`, `alasan_pindah`, `alamat_pindah`, `dusun_pindah`, `rt_pindah`, `rw_pindah`, `desa_pindah`, `kecamatan_pindah`, `kabupaten_pindah`, `provinsi_pindah`, `kode_pos_pindah`, `telepon_pindah`, `tanggal_pindah`, `agama`) VALUES
...
INSERT INTO `pindahdatang` (`no_kk`, `nama_kepala_keluarga`, `alamat`, `agama`, `rt`, `rw`, `nik`, `nama`, `foto`, `pekerjaan`, `alasan_pindah`, `alamat_tujuan`, `tanggal_pindah`, `jenis_pindah`, `klasifikasi_pindah`, `status_kk_pindah`, `status_kk_tdk_pindah`) VALUES
(11, '', 'Aasa   ', 'Islam', '12', 'Kepala Dusun Krajan 2', '123456', 'Muhammad Wendy ', '', 'wqwq', 'Keamanan', 'JL Raya puspitek serpong,za gang salem 3     ', '2024-05-02', 'Kepala Keluarga', 'Antar Desa', '', '');
...
(25, 'Muhammad wendy', '19220300@bsi.ac.id', 'default.jpg', '$2y$10$UrEwDkKVObjj/pHlySztYeMXGiqiiFPLamELhlOODS/plGtLYAOMK', 1, 1, 1716809010, '', 'staff desa');
...
--
-- Indexes for table `belum_sekolah`
--
...
--
ALTER TABLE `pindahdatang`
  MODIFY `no_kk` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
