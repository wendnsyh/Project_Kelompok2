...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="<?= base_url('admin/announcement/update/' . $announcement['id']); ?>" method="POST">
                <div class="form-group">
                    <label for="judul">Judul</label>
                    <input type="text" class="form-control" id="judul" name="judul"
                        value="<?= $announcement['judul']; ?>" placeholder="Masukkan Judul Ringkas">
                </div>
                <div class="form-group">
                    <label for="tanggal">Tanggal</label>
                    <input type="date" class="form-control" id="tanggal" name="tanggal"
                        value="<?= $announcement['tanggal']; ?>" placeholder="Masukkan Tanggal">
                </div>
                <div class="form-group">
                    <label for="deskripsi">Deskripsi</label>
                    <input type="text" class="form-control" id="deskripsi" name="deskripsi"
                        value="<?= $announcement['deskripsi']; ?>" placeholder="Masukkan Isi Pengumuman">
                </div>
